...
namespace Yirius\AdminCms\command;
...
class Init extends Command
{
    ...
    {
        $this
            ->setName('admin:cmsinit')
            ->setDescription("this command use for init cms's table and css");
    }
    ...
    protected function createTable(Output $output)
    {
        try{
            ...
            $sqlContent = file_get_contents(dirname(THINKER_CMS_ROOT) . DS . "sql" . DS . "php.sql");
    ...
    protected function copyAssets(Output $output)
    {
        ...
        $this->copy_dir(dirname(THINKER_CMS_ROOT) . DS .  "assets" . DS, $publicPath);
